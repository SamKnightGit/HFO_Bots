...
def get_action(action_num, numTeammates):
    pass
...
if __name__ == '__main__':
    ...
    qtable_dir = os.path.dirname(os.path.realpath(__file__)) + '/qtables/q_learner'
    q_learner = QLearner(NUM_STATES, NUM_ACTIONS,
                         q_table_in  = qtable_dir + str(args.playerIndex) + '.npy',
                         q_table_out = qtable_dir + str(args.playerIndex) + '.npy')
